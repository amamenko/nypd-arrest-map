                  ...
                  [
                      ...
                      (() => {
                        onmessage = (e) => {
                          ...
                          const filterArrIncluded = (x, filterExactName) => {
                          ...
                          const dataReducerFunction = (chunk, filterExactName) => {
                          ...
                          const boroughLoadDataReducerFunction = (chunk, filterExactName) => {
                            return chunk.reduce((acc, curr) => {
                              const currentName = (x) => {
                                if (
                                  x[filterExactName] === "K" &&
                          ...
                          const datesDataReducer = (filterExactName) => {
                            ...
                            const dateFilterArrIncluded = (item, index) => {
                              ...
                              .map((x, i) => [
                                ...new Set(
                                  x.reduce((acc, curr) => {
                                    ...
                                    if (dateFilterArrIncluded(exactName, i)) {
                                      acc.push(exactName);
                                    }
                          ...
                          postMessage(
                            JSON.stringify({
                              ...
                              boroughArr: boroughLoadDataReducerFunction(flatLoadData, "ARREST_BORO"),
                              offenseDescriptionArr: dataReducerFunction(flatLoadData, "OFNS_DESC"),
                              filteredArrestCategory: dataReducerFunction(flatFilteredData, "LAW_CAT_CD"),
                              filteredAgeGroup: dataReducerFunction(flatFilteredData, "AGE_GROUP"),
                              filteredSexArr: dataReducerFunction(flatFilteredData, "PERP_SEX"),
                              filteredRaceArr: dataReducerFunction(flatFilteredData, "PERP_RACE"),
                              filteredBoroughArr: boroughLoadDataReducerFunction(flatFilteredData, "ARREST_BORO"),
                              filteredOffenseDescriptionArr: dataReducerFunction(flatFilteredData, "OFNS_DESC"),
                              filteredUniqueCategory: dataReducerFunction(filteredDataChunks, "LAW_CAT_CD"),
                              filteredUniqueDates: datesDataReducer(filteredDataChunks, "ARREST_DATE")
                            }))
